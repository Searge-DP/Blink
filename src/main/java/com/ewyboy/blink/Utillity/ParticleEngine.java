...
public class ParticleEngine {
    ...
    public static void spawnEnderParticle(int x, int y, int z, World world) {
        for(double i = 0; i <= Math.PI; i +=0.010) {
            double adjustedX = i * Math.cos(i);
            double adjustedZ = i * Math.sin(i);

            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedX, i, adjustedZ);
            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedX*(-1), i, adjustedZ*(-1));
            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedX*(-1), i, adjustedZ);
            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedX, i, adjustedZ*(-1));

            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedZ, i, adjustedX);
            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedZ*(-1), i, adjustedX*(-1));
            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedZ*(-1), i, adjustedX);
            world.spawnParticle("magicCrit",x+0.5,y,z+0.5, adjustedZ, i, adjustedX*(-1));
        }
    }
}
